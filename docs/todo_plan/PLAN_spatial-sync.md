...
- [x] Google Cloud Console 프로젝트 생성 + Maps JS API 키 발급 + 테스트
- [x] Google AI Studio Gemini API 키 발급 + `gemini-2.0-flash` 호출 테스트
- [x] 12개 랜드마크 구글/네이버 지도 좌표 수동 수집 → test_coordinates.json 작성
...
**형섭님:**
- [x] Gemini Self-Correction CoT 프롬프트 작성
...
- [x] Google Maps API 키 로딩 확인

### Phase 2: 핵심 구현 (11:00~13:00)

**형섭님:**
- [x] pyproj 변환 함수 (EPSG:4326 ↔ EPSG:5179)
- [x] Haversine RMSE 계산 함수
...
- [x] split-view HTML 레이아웃 (CSS grid)
...
**형섭님:**
- [x] Self-Correction 폴백 (Gemini 실패 → RMSE만)
...
- [x] Backend ↔ Frontend 연결
- [x] 강남역 E2E 테스트
- [x] 12개 배치 테스트
- [x] 에러 시나리오 (도쿄, Gemini 타임아웃)
- [x] 버그 수정
